...
const FAST_REPLIES = [
    ...
    // ============================================
    {
        ...
        match: (text) => {
            const t = normalize(text);
            return /(falar com (humano|atendente|jocimar|pessoa)|chamar (humano|jocimar|atendente)|atendente real|reclamacao|reclam(ar|o)|insatisfeit|com raiva|odiei|horrivel|merda|fila|demoraram|frio|nao chegou|nao recebi|errado o pedido|pedido errado)/.test(t)
                || t === "4" || t === "4️⃣";
        },
        reply: () => `Já chamei um atendente aqui amorzinho 💜🐑\nVai te atender em pouquinho viu?\n(Pode demorar uns minutinhos pq tá cuidando da loja)\n\nEnquanto isso me conta o que aconteceu pra eu já adiantar pra equipe 💕`
    },
    ...
    // ============================================
    {
        ...
        reply: (ctx) => {
            ...
            return `Você tá falando comigo no WhatsApp oficial! 💜\n📞 *${num}*\nQuer falar com um atendente direto? É esse mesmo número, a equipe responde quando tá disponível 🐑`;
        }
    }
];
