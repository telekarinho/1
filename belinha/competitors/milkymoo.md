...
- **Apenas milkshake** — não tem potinho personalizado, nem açaí self-service
- **Sem linha Fit/Zero/Proteína** — ignora público fitness crescente
- **Franquia R$190k** — barreira alta vs Kit Entrada MilkyPot R$3.499
- ROI 18–24 meses vs MilkyPot "payback em semanas"
- Mascote vaca vs ovelhinha MilkyPot — menos diversidade criativa de personagem

### Oportunidades para MilkyPot
- Funil próprio (WhatsApp + milkypot.com) = **zero comissão**, base de dados própria
- Linha Zero/Fit com proteína — nicho fitness abandonado pela Milky Moo
- Potinho = produto mais versátil (Ninho, Açaí, toppings ilimitados)
- Açaí buffet self-service na unidade Muffato = formato único
- Gamificação (raspinha da sorte, desafio milissegundos) = retenção
...
> "Na MilkyPot você monta o seu potinho do jeito que você quer — Ninho, Açaí, Zero ou Fit.  
> Sem comissão pra aplicativo, sem fila virtual: só no nosso WhatsApp ou direto na loja. 🐑"
...
## Atualização Ciclo #84 — 2026-05-01

**Fontes:** auroracultural.com, gkpb.com.br, catuailondrina.com.br, boulevardlondrinashopping.com.br, TikTok @marceladegusta

### 🆕 Novidade Estratégica — Day Part 180ml (lançado 30/04/2026)

A MilkyMoo lançou em **30 de abril de 2026** o formato **180ml** do milkshake, com preço a partir de **R$ 12,90** disponível **apenas até as 13h59** (ação "Day Part"). O produto está disponível em todos os sabores do cardápio exceto versões premium e alcoólicas.

**Análise estratégica:**
- Cria nova janela de consumo pós-almoço (12h–14h) — segmento que MilkyMoo não cobria
- Preço de entrada mais baixo (R$12,90 vs R$18/300ml habitual) reduz barreira trial
- Operador MilkyPot: avaliar se o horário 12h–14h tem potencial de movimentação no Muffato. Se sim, criar promoção equivalente nessa janela ("Potinho do Almoço" ou desconto Linha Zero).

### 🆕 Páscoa 2026 — Linha de Ovos de Chocolate

A MilkyMoo lançou dois ovos de Páscoa para 2026:
- **Ovo Pandora:** chocolate branco + chocolate ao leite + creme de avelã
- **Ovo Malhada:** chocolate ao leite + recheio sabor leite + biscoito de chocolate

**Aprendizado para MilkyPot:** extensão de produto sazonal de alto ticket fotogênico. Páscoa 2027 = oportunidade para criar "Potinho de Páscoa" edição limitada.

### Preços atualizados (confirmados ciclo #84)

| Formato | Milkshake padrão | Premium (Nutty Bavarian) | Alcoólico |
|---|---|---|---|
| 180ml (novo — até 13h59) | R$ 12,90 | — | — |
| 300ml | R$ 18,00 | R$ 27,00 | R$ 25,00 |
| 500ml | R$ 22,00 | R$ 32,00 | R$ 35,00 |

### Londrina (confirmado ciclo #84)

- **Catuaí Shopping:** ativo, horários seg–sab 10h–22h / dom e feriados 14h–20h
- **Boulevard Shopping:** ativo
- **iFood:** presente nas duas unidades. Sem unidade no Muffato.

### Alertas Estratégicos (Ciclo #84)

1. **Day Part 180ml = guerra de horário:** MilkyMoo busca preencher a janela pós-almoço. MilkyPot tem oportunidade de contrariar com promoção no mesmo horário ("Potinho Rápido do Almoço") — especialmente relevante para clientes do Muffato que saem do supermercado na hora do almoço.
2. **Páscoa 2026 como template:** linha sazonal de produto com chocolate = formato fotogênico de alto apelo. MilkyPot deve ter resposta sazonal equivalente para Páscoa 2027.
3. **Preços estáveis vs MilkyPot:** ticket MilkyMoo (R$18–22) é compatível com potinhos MilkyPot (R$14–22). Não há guerra de preços — diferenciação por produto e funil.

- [x] Novo formato 180ml Day Part documentado
- [x] Páscoa 2026 documentada
- [x] Preços atualizados
- [x] Unidades Londrina confirmadas (Catuaí + Boulevard)
- [ ] Verificar se MilkyMoo abre nova unidade no Muffato (monitoramento contínuo)
- [ ] Analisar ads Meta Ads Library @milkymoo_londrina (campanha Day Part)
