...
- **Segmento:** Açaí self-service + sorvete (overlap com unidade Muffato da MilkyPot)
- **Origem:** Londrina-PR 🔴 (MESMO MERCADO — concorrente local prioritário)
- **Fundação:** 2017, por 3 engenheiros recém-formados
- **Unidades:** ~1.012 (812 operacionais + 200 em implementação — abr/2026) | meta 2.000 unidades até 2027
- **Faturamento:** R$ 777M (2024) → **R$ 1,1 bilhão (2025)** → meta **R$ 1,5 bilhão (2026)**
- **Prêmio:** Franquia que mais cresceu no Brasil em 2024 (ABF)
- **Investimento externo:** R$ 80M da Auster Capital (recente) para expansão e internacionalização
- **Clientes/dia:** 100.000+ atendidos nacionalmente
- **Plataformas:** iFood, delivery próprio (deliverythebestacai.com.br)
- **Indústria própria:** Amadelli (Ibiporã-PR) — 80 ton açaí/dia; meta R$ 300M faturamento próprio
- **Nova sede:** inaugurada em Londrina 2025 (cidade de origem — reforço de raízes locais)
...
|---|---|
| Sabores de açaí | 12 |
| Sabores de sorvete | 24 |
| Toppings | 40+ (frutas, cremes, doces — ninho, nutella, morango, leite condensado) |
| Extras | Waffles, milkshakes, fondue, combos, bebidas (Coca-Cola, Fanta, Guaraná, energético) |
| Donuts (**2025**) | The Best Donuts — primeiro self-service de donuts do Brasil (jan/2025, 580+ lojas) |
| Sorbet 100% fruta (**NOVO 2025**) | Sem açúcar, sem conservantes — primeiro produto "sem culpa" da rede |
| Modelo | Self-service pesado por 100g |

**Nota:** Nenhuma linha Zero/Fit com proteína identificada — foco é volume/variedade. O sorbet 100% fruta é a primeira aproximação com o segmento saudável.

**🍩 The Best Donuts:** self-service de donuts em 580+ lojas — diversificação para além do açaí, concorrência direta com sobremesas artesanais no segmento "snack doce premium".

**🍧 Sorbet 100% fruta (2025):** primeira incursão no território "sem açúcar" — sinal de que a TheBest começa a disputar o público fitness que hoje está 100% no território da Linha Zero MilkyPot. Monitorar desenvolvimento.

---

## Preços (Londrina — dados coletados 2026)

| Situação | Preço/100g |
|---|---|
| Preço regular (loja Gleba Palhano) | **R$ 6,29 / 100g** (confirmado 2025) |
| Promoção reinauguração (Arthur Thomas jul/2024) | R$ 3,99 / 100g |
| Preço base reportado (portaldofranchising) | R$ 2,89 / 100g (formato menor / promoção)|

### Comparativo por porção vs MilkyPot

| Porção estimada | The Best Açaí | MilkyPot |
|---|---|---|
| ~200g | R$ 12,58 | R$ 14,00 (Pequeno — fixo, personalizado) |
| ~300g | R$ 18,87 | R$ 18,00 (Médio — fixo, personalizado) |
| ~350g | R$ 22,02 | R$ 22,00 (Gigante — fixo, personalizado) |

**Insight:** Preços comparáveis por porção. MilkyPot tem previsibilidade (preço fixo) vs TheBest tem variabilidade (pesa quanto serve). Cliente TheBest costuma montar porção maior que planejado — ticket médio real tende a ser mais alto.

---

## Unidades em Londrina (confirmadas — atualizado ciclo #73)

| Endereço | Bairro | Obs |
|---|---|---|
| Rua Caracas, 159 | Gleba Palhano | **Loja flagship** — 310m², 100+ lugares, pet space, TVs, bleachers |
| Av. Alziro Zarur, 86 — Loja 02 | San Conrado | Próximo ao aeroporto |
| Rua Pio XII, 700 E | Centro | Loja compacta |
| Av. Arthur Thomas, 831 | Zona Sul | Reinaugurou jul/2024 |
| Av. Higienópolis | Higienópolis | Confirmada no iFood |
| **Shopping Aurora** | **Londrina** | **🆕 QUIOSQUE inaugurado jun/2025 — NOVO FORMATO** |

### ⚠️ ALERTA: Quiosque Shopping Aurora (novo — jun/2025)

A TheBest inaugurou seu **primeiro quiosque em shopping** no Shopping Aurora, Londrina. Este é o modelo piloto para expansão de **300–500 quiosques** em shoppings brasileiros.

| Item | Dados |
|---|---|
| Formato | Quiosque self-service (menor que lojas) |
| Produtos | 16 opções: açaí + sorvetes + 4 cremes + 3 frutas + 4 toppings |
| Investimento | R$ 150.000 |
| Faturamento projetado | R$ 60.000/mês |
| Payback | 16–20 meses |
| Tecnologia | Totens de autoatendimento (menos funcionários) |

**✅ SEM unidade no Muffato (Av. Quintino Bocaiuva, 1045) — janela de oportunidade para MilkyPot ainda mantida.** Monitorar se a estratégia de quiosques alcança o Muffato.
...
| Modelo | Investimento |
|---|---|
| Loja padrão | A partir de R$ 230.000 (taxa inclusa) |
| Quiosque shopping (NOVO) | R$ 150.000 — payback 16–20 meses |
| Payback loja padrão | 16–18 meses |
| Royalties | Não cobra sobre faturamento |
| Internacionalização | 4 lojas na Flórida/EUA (1H2026); Paraguai 15 lojas |

**vs MilkyPot Kit Loja:** R$ 25.000 e payback 6 meses — posicionamento muito mais acessível.

---

## Análise vs MilkyPot (unidade Muffato)

### Ameaças

- **Marca local forte:** nasceu em Londrina em 2017 — muito reconhecimento regional
- **iFood presente:** atinge clientes delivery que MilkyPot não alcança diretamente
- **Escala:** 900+ unidades vs 1 — percepção de confiança/credibilidade massiva
- **Preço self-service:** pode parecer "mais barato" a quem monta porção pequena
- **Variedade de sorvete:** 24 sabores — apelo de loja de sorvetes + açaí

### Vantagens MilkyPot

- **Potinho personalizado = experiência única:** não é commodity, é produto com identidade
- **Linha Zero/Fit com proteína:** nicho fitness inexistente na TheBest
- **Base Ninho:** diferencial forte — TheBest tem Ninho apenas como topping, não como base cremosa
- **Preço fixo previsível:** cliente sabe exatamente o que vai pagar antes de montar
- **Funil próprio:** WhatsApp direto, sem comissão iFood (~30%)
- **Mascote + estética candy:** apelo emocional vs ambiente genérico de self-service
- **Milkshakes artesanais:** diferencial vs self-service industrial
- **Presença no Muffato:** acesso ao fluxo de clientes do supermercado (captação passiva)

---

## Copy/Argumentos para Contrapor The Best Açaí

- "Não é buffet. É o **seu** potinho, do **seu** jeito."
- "Preço fixo, sem susto na balança."
- "Tem Ninho de verdade — cremoso, pesado, irresistível."
- "Linha Fit com proteína. Prazer sem culpa, com saúde de verdade."
- "Direto no WhatsApp. Sem app, sem taxa, sem complicação."

---

## Monitoramento

- [x] Preços confirmados (R$6,29/100g Gleba Palhano)
- [x] Faturamento e escala atualizados (R$777M / 900 unidades)
- [x] Novo produto The Best Donuts documentado
- [ ] Checar se abre unidade no Muffato ou raio 1km (alerta de ameaça contínua)
- [ ] Comparar UGC (reels, stories de clientes) TheBest vs MilkyPot pós-inauguração
- [ ] Monitorar expansão The Best Donuts em Londrina — ameaça ao segmento doce artesanal

---

## Monitoramento (atualizado ciclo #73)

- [x] Preços confirmados (R$6,29/100g Gleba Palhano)
- [x] Faturamento e escala atualizados (R$1,1B / 1.000+ unidades)
- [x] Novo produto The Best Donuts documentado
- [x] **Quiosque Shopping Aurora Londrina documentado (🆕 CRÍTICO)**
- [x] Sorbet 100% fruta documentado (incursão território fit)
- [ ] Checar se TheBest abre quiosque no Muffato ou raio 1km (alerta contínuo — agora com modelo quiosque viável)
- [ ] Comparar UGC (reels, stories de clientes) TheBest vs MilkyPot pós-inauguração
- [ ] Monitorar expansão The Best Donuts em Londrina — ameaça ao segmento doce artesanal
- [ ] Verificar preço atual do quiosque Shopping Aurora (16 opções vs lojas completas)

---

## Alertas Estratégicos (Ciclo #73)

1. **Escala acelerada:** 1.000+ unidades e R$1,1B em 2025. TheBest é player dominante em Londrina. MilkyPot NÃO deve competir em preço ou volume.
2. **Quiosque Shopping Aurora = ameaça de modelo replicável:** 300–500 quiosques planejados para shoppings. Se chegarem ao Muffato (formato quiosque), a vantagem de localização da MilkyPot é ameaçada. Monitorar com prioridade.
3. **Sorbet sem açúcar (2025):** primeira sinalização de disputa pelo público fit. Se a TheBest lançar linha Zero completa, o diferencial da Linha Zero MilkyPot se reduz — resposta: enfatizar PROTEÍNA (ingrediente que TheBest não tem).
4. **Foco no que TheBest NÃO tem:** base Ninho cremosa, linha Fit c/ proteína, preço fixo (sem balança), identidade de marca com mascote/narrativa emocional, funil próprio sem iFood.
5. **Localização Muffato:** gap ainda existente — TheBest não está no Muffato (Quintino Bocaiuva). Fluxo do supermercado = vantagem exclusiva MilkyPot. Vigilância aumentada com modelo quiosque em curso.
